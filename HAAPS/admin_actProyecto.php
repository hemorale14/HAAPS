...
<body onload="enfoque('lstNombre'); tablaProyectos('divTabla', 'actions.php', 'tablaProyectos');">
    ...
    <!-- inicio cuerpo -->
     ...
     <div id="center">
      ...
      <br /><br />
      <div align="center">
       <form id="frmActualizar" name="frmActualizar" onsubmit="">
    ...
    <tr>
      <td width="2%">&nbsp;</td>
			...
			<td width="54%">
            <select name="lstNombre" id="lstNombre" onblur="xmlProyecto('generarXMLProyecto');">
<?php
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
			...
			<td><textarea id="txtDescripcion" name="txtEmail" maxlength="" onblur="validarDato(this.value, this.id, 'divDescripcion', 'actions.php', 'validarDato');"></textarea><div id="divDescripcion" class="error"></div></td>
			<td>&nbsp;</td>
	</tr>
    <tr>
      <td>&nbsp;</td>
			<td><b>Responsable:</b></td>
			<td><input type="text" id="txtResponsable" name="txtResponsable" maxlength="" onblur="validarDato(this.value, this.id, 'divResponsable', 'actions.php', 'validarDato');"/><div id="divResponsable" class="error"></div></td>
			<td>&nbsp;</td>
	</tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="4" align="center"><input id="form_submit" name="btnActualizar" type="submit" value="Actualizar" onclick="actProyecto('actProyecto'); return false;" />
     ...
     <div class="right">
      ...
      <div class="tit_bot">
       <ul>
        ...
        <li><a href="admin_eliProyecto.php">Eliminar</a></li>
