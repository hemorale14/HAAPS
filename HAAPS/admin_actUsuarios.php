...
?>
    ...
    <tr>
      <td colspan="4" align="center"><input id="form_submit" name="btnRestablecer" style="width:auto" type="submit" value="Restablecer" onclick="actCliente('actCliente'); return false;" />
    </td>
    </tr>
    <tr>
