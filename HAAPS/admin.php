...
<body onload="enfoque('txtNombre'); tablaProyectos('divTabla', 'actions.php', 'tablaProyectos');">
    ...
    <tr>
      <td colspan="4" align="center"><input id="form_submit" name="btnEnviar" type="submit" value="Enviar" onclick="enviarProyectos('insProyecto'); return false;" />
