...
<body onload="enfoque('lstEmail'); tablaProyectos('divTabla', 'actions.php', 'tablaUsuarios');">
    ...
    <tr>
      ...
      <td width="54%">
        <select name="lstEmail" id="lstEmail">
  <?php
require_once('ajax/clases/baseDatos.class.php');
$bd = bD::getInstance();
$usuarios = $bd->consultar("usuario", "Email", "");
...
?>
    ...
    <tr>
      <td colspan="4" align="center"><input id="form_submit" name="btnEliminar" style="width:auto" type="submit" value="Eliminar" onclick="actCliente('eliUsuario'); return false;" />
    </td>
    </tr>
    <tr>
