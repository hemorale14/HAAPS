...
<form name="frmRegistrar" onsubmit="">
    ...
    <tr>
			...
			<td><input name="txtCodigo" type="text" id="txtCodigo" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="15" onblur="validarEquipo(this.value, this.id, 'divCodigo', 'validarRouter.php')"/>
      <div id="divCodigo" class="error" style="margin-left:auto"></div></td>
	</tr>
    <tr>
			<td><span class="color">*</span>Marca:</td>
			<td><input name="txtMarca" type="text" id="txtMarca" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="15" onblur="validarEquipo(this.value, this.id, 'divMarca', 'validarRouter.php')"/>
      <div id="divMarca" class="error" style="margin-left:auto"></div></td>
	</tr>
    <tr>
			<td><span class="color">*</span>Modelo:</td>
			<td><input name="txtModelo" type="text" id="txtModelo" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="20" onblur="validarEquipo(this.value, this.id, 'divModelo', 'validarRouter.php')"/>
    ...
    <tr>
	<td><span class="color">*</span>Factor Forma:</td>
			<td><input name="txtFactor" type="text" id="txtFactor" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="8" onblur="validarEquipo(this.value, this.id, 'divFactor', 'validarRouter.php')"/>
            <div id="divFactor" class="error" style="margin-left:auto"></div></td>
	</tr>
     <tr>
	<td><span class="color">*</span>SW:</td>
			<td><input name="txtSW" type="text" id="txtSW" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divSW', 'validarRouter.php')"/>
            <div id="divSW" class="error" style="margin-left:auto"></div></td>
	</tr>
     <tr>
	<td><span class="color">*</span>Capacidad:</td>
			<td><input name="txtCapacidad" type="text" id="txtCapacidad" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divCapacidad', 'validarRouter.php')"/>
            <div id="divCapacidad" class="error" style="margin-left:auto"></div></td>
	</tr>
     <tr>
	<td><span class="color">*</span>SO:</td>
			<td><input name="txtSO" type="text" id="txtSO" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divSO', 'validarRouter.php')"/>
    ...
    <tr>
			<td colspan="2"><input name="btnRegistrar" type="submit" value="Registrar" style="width: 80px;" onclick="enviarRouter(); return false"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$bd = bD::getInstance();
$equipos = $bd->consultar("equipo", "codigo", "WHERE Tipo='R'");
...
?>
    ...
    <tr>
	<td>Factor Forma:</td>
			<td><input name="txtFactor" type="text" id="txtFactor" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="8" onblur="validarEquipo(this.value, this.id, 'divFactor', 'validarRouter.php')"/></td>
	</tr>
     <tr>
	<td>SW:</td>
			<td><input name="txtSW" type="text" id="txtSW" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divSW', 'validarRouter.php')"/></td>
	</tr>
     <tr>
	<td>Capacidad:</td>
			<td><input name="txtCapacidad" type="text" id="txtCapacidad" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divCapacidad', 'validarRouter.php')"/></td>
	</tr>
     <tr>
	<td>SO:</td>
			<td><input name="txtSO" type="text" id="txtSO" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divSO', 'validarRouter.php')"/>
    ...
    <tr>
			<td colspan="2"><input name="btnActualizar" type="submit" value="Actualizar" style="width: 80px;" onclick="acRouter(); return false"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
?>
    ...
    <tr>
			<td colspan="2"><input name="btnRegistrar" type="submit" value="Eliminar" style="width: 80px;" onclick="eliRouter(); return false"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  <input name="txtCancelar" type="reset" value="Cancelar" style="width: 80px;"/></td>
			</tr>
    <tr>
			<td colspan="2" align="center"><div></div></td>
