...
<form name="frmRegistrar" onsubmit="">
    ...
    <tr>
			<td colspan="2"><input name="btnRegistrar" type="submit" value="Registrar" style="width: 80px;" onclick="enviarPc('pcs.php'); return false"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<form name="frmActualizar" onsubmit="">
    ...
    <tr>
			...
			<td><select name="lstCodigo" id="lstCodigo" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" onblur="actPc('generarXMLPc.php');">
<?php
require_once('ajax/clases/baseDatos.class.php');
$bd = bD::getInstance();
$equipos = $bd->consultar("equipo", "codigo", "WHERE Tipo='PC'");
...
?>
    ...
    <tr>
			<td colspan="2"><input name="btnRegistrar" type="submit" value="Eliminar" style="width: 80px;" onclick="eliPc('eli_pcs.php'); return false"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  <input name="txtCancelar" type="reset" value="Cancelar" style="width: 80px;"/></td>
			</tr>
    <tr>
			<td colspan="2" align="center"><div></div></td>
