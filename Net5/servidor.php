...
<form name="frmRegistrar" onsubmit="">
    ...
    <tr>
			...
			<td><input name="txtCodigo" type="text" id="txtCodigo" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="15" onblur="validarEquipo(this.value, this.id, 'divCodigo', 'validarPc.php')"/>
      <div id="divCodigo" class="error" style="margin-left:auto"></div></td>
	</tr>
    <tr>
			<td><span class="color">*</span>Marca:</td>
			<td><input name="txtMarca" type="text" id="txtMarca" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="15" onblur="validarEquipo(this.value, this.id, 'divMarca', 'validarPc.php')"/>
      <div id="divMarca" class="error" style="margin-left:auto"></div></td>
	</tr>
    <tr>
			<td><span class="color">*</span>Modelo:</td>
			<td><input name="txtModelo" type="text" id="txtModelo" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="20" onblur="validarEquipo(this.value, this.id, 'divModelo', 'validarPc.php')"/>
    ...
    <tr>
	<td><span class="color">*</span>Procesador:</td>
			<td><input name="txtProcesador" type="text" id="txtProcesador" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="8" onblur="validarEquipo(this.value, this.id, 'divProcesador', 'validarPc.php')"/>
            <div id="divProcesador" class="error" style="margin-left:auto"></div></td>
	</tr>
     <tr>
	<td><span class="color">*</span>SO:</td>
			<td><input name="txtSO" type="text" id="txtSO" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divSO', 'validarPc.php')"/>
            <div id="divSO" class="error" style="margin-left:auto"></div></td>
	</tr>
     <tr>
	<td><span class="color">*</span>RAM:</td>
			<td><input name="txtRam" type="text" id="txtRam" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divRam', 'validarPc.php')"/>
            <div id="divRam" class="error" style="margin-left:auto"></div></td>
	</tr>
     <tr>
	<td><span class="color">*</span>Disco Duro:</td>
			<td><input name="txtDicoDuro" type="text" id="txtDiscoDuro" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divDiscoDuro', 'validarPc.php')"/>
            <div id="divDiscoDuro" class="error" style="margin-left:auto"></div></td>
	</tr>
    <tr>
    ...
    <tr>
			<td colspan="2"><input name="btnRegistrar" type="submit" value="Registrar" style="width: 80px;" onclick="enviarPc('servidores.php'); return false"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<form name="frmActualizar" onsubmit="">
    ...
    <tr>
			...
			<td><select name="lstCodigo" id="lstCodigo" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" onblur="actPc('generarXMLServidor.php');">
<?php
require_once('ajax/clases/baseDatos.class.php');
$bd = bD::getInstance();
$equipos = $bd->consultar("equipo", "codigo", "WHERE Tipo='S'");
...
?>
    ...
    <tr>
	<td>Procesador:</td>
			<td><input name="txtProcesador" type="text" id="txtProcesador" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="8" onblur="validarEquipo(this.value, this.id, 'divFactor', 'validarPc.php')"/></td>
	</tr>
     <tr>
	<td>SO:</td>
			<td><input name="txtSO" type="text" id="txtSO" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divSW', 'validarRouter.php')"/></td>
	</tr>
     <tr>
	<td>Ram:</td>
			<td><input name="txtRam" type="text" id="txtRam" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divCapacidad', 'validarRouter.php')"/></td>
	</tr>
     <tr>
	<td>Disco Duro:</td>
			<td><input name="txtDiscoDuro" type="text" id="txtDiscoDuro" style="font-family:Verdana, Geneva, sans-serif; height:16px; font-size:10px" maxlength="45" onblur="validarEquipo(this.value, this.id, 'divSO', 'validarRouter.php')"/>
            </td>
	</tr>
    <tr>
    <td>Cantidad:</td>
    ...
    <tr>
			<td colspan="2"><input name="btnActualizar" type="submit" value="Actualizar" style="width: 80px;" onclick="acPc('act_pcs.php'); return false"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
?>
    ...
    <tr>
			<td colspan="2"><input name="btnRegistrar" type="submit" value="Eliminar" style="width: 80px;" onclick="eliPc('eli_servidores.php'); return false"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  <input name="txtCancelar" type="reset" value="Cancelar" style="width: 80px;"/></td>
			</tr>
    <tr>
			<td colspan="2" align="center"><div></div></td>
